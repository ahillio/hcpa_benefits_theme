...
<?php endif; /* !$ajax */ ?>
  <section id="page" role="main" class="clearfix <?php echo $main_classes; ?> col-sm-push-4">
    <?php print $messages; ?>
    <a id="main-content"></a>
  ...
  <?php if ($page['sidebar_first']): ?>
    <aside id="sidebar-first" role="complimentary" class="sidebar clearfix <?php echo $sidebar_first_classes; ?> col-sm-pull-8">
